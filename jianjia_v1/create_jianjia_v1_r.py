...
def create_my_episode(file_folder, path):
    ...
    for step in range(EPISODE_LENGTH):
        ...
        # 1. image
        image_filename = step_info['observation']['right_image_filename']
        ...
        state = position + orientation_rpy
...
if __name__ == "__main__":
    data_folder = "/SSD/Data/20241118_set4/"
    sub_folders = os.listdir(data_folder)
    all_nums = len(sub_folders)
    N_TRAIN_EPISODES = all_nums
    N_VAL_EPISODES = int(all_nums*0.1)
